...
defined('DATABASE_USER_NAME') ? null : define('DATABASE_USER_NAME', 'cars_makeR');
defined('DATABASE_PASSWORD') ? null : define('DATABASE_PASSWORD', "cars_makeR20");
defined('DATABASE_DB_NAME') ? null : define('DATABASE_DB_NAME', 'cars');
